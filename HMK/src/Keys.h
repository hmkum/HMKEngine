...
#define HMK_MOUSE_BUTTON_4   3
#define HMK_MOUSE_BUTTON_5   4
#define HMK_MOUSE_BUTTON_6   5
#define HMK_MOUSE_BUTTON_7   6
#define HMK_MOUSE_BUTTON_8   7
#define HMK_MOUSE_BUTTON_LAST HMK_MOUSE_BUTTON_8
#define HMK_MOUSE_BUTTON_LEFT HMK_MOUSE_BUTTON_1
#define HMK_MOUSE_BUTTON_RIGHT HMK_MOUSE_BUTTON_2
#define HMK_MOUSE_BUTTON_MIDDLE HMK_MOUSE_BUTTON_3